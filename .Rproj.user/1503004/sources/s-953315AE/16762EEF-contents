...
# Ans: Aesthetics defined globally in plot_c but only locally in plot_b
...
ggsave("plots/tidyverse/default_leu1_plot.png")

# Or specify the size

ggsave("plots/tidyverse/correct_size_leu1_plot.png",
       width = 10, 
       height = 8, 
       dpi = 300, 
       units = "cm")
...
ggsave("plots/tidyverse/pdf_version_of_leu1_plot.pdf",
       width = 10, 
       height = 8, 
       dpi = 300, 
       units = "cm")
