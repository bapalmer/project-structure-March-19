...
###########################################################################
# Data --------------------------------------------------------------------
# The source() function below will read in a single clean tibble
# It is a tidy version of the WHO tuberculosis which comes with tidyr

source("scripts/03_pm_clean_data.R")
...
# The plot has not displayed as it is stored as a plot object
who_ire
...
# Plot B - working in a specific research question
...
# Finalising the plot -----------------------------------------------------
# Plot C - respond to reviewer comments quickly
...
# Now lets make the changes to satisfy the reviewer comments
